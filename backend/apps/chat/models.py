...
class Conversation(models.Model):
    ...
    participants = models.ManyToManyField(
        settings.AUTH_USER_MODEL, related_name="conversations", verbose_name=_("المشاركون")
    )
...
class Message(models.Model):
    ...
    sender = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="sent_messages", verbose_name=_("المرسل")
    )
